...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['verify_user'])) {
    ...
    // Verify the instructor details
    $sql = "SELECT * FROM Instructor WHERE I_ID='$instructor_id' AND username='$username' AND Phone_number='$phone_number'";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['reset_password'])) {
    ...
    if ($password !== $confirm_password) {
        ...
        $update_sql = "UPDATE Instructor SET Password='$password' WHERE I_ID='$instructor_id' AND username='$username'";
...
<body>
    <div class="reset-password-container">
        ...
        <div class="back-to-login">
            <a href="I_login.php">Back to Login</a>
        </div>
    </div>
</body>
</html>
